...
<body>
			...
			<div class="col-md-4">	
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Last Login : <?php echo date("d/m/Y") ?></p>
				...
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body">
						        <h4 class="card-title">BILLING SYSTEM</h4>
						        <p class="card-text">Here you can make invoices and create new orders</p>
						        <a href="new_order.php" class="btn btn-primary">OPEN</a>
						      </div>
						    </div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card" style="margin-top:20px">
						...
						<p class="card-text">Here you can view User details</p>
						<a href="manage_view.php" class="btn btn-primary">View</a>
			...
			<div class="col-md-6">
				<div class="card" style="margin-top:20px">
					<div class="card-body">
						...
						<p class="card-text">Here you can view Supplier details</p>
						<a href="#" data-toggle="modal" data-target="#form_suppliers" class="btn btn-primary" >Add</a>
						<a href="suppliers.php" class="btn btn-primary">Manage</a>
						<!--<a href="manage_user.php" class="btn btn-primary">Manage</a>-->
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="card" style="margin-left:20px">
					<div class="card-body">
						...
						<p class="card-text">Here you can give any suggestion/problem/feedback</p>
						<a href="feedback.php" class="btn btn-primary">Add</a>
						<a href="manage_feedback.php" class="btn btn-primary">Manage</a>
					</div>	
				</div>
			</div>
		</div>
	...
	<?php
	//Suppliers Form
	include_once("./templates/supplier_modal.php");
	 ?>
