		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6" id="payment_type">
					...
					<center>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="hosted_button_id" value="PF925824BMC6N">
							<input type="image" src="https://www.paypalobjects.com/en_GB/i/btn/btn_cart_LG.gif" border="2" name="submit" alt="PayPal – The safer, easier way to pay online!">
							<img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
						</form>
					</center>
                    <center>
                      <input type="submit" id="order_form" style="width:150px;" class="btn btn-info" value="BILL/PRINT">
                      <input type="submit" id="print_invoice" style="width:150px;" class="btn btn-success d-none" value="PF925824BMC6N"><!--Print Invoice-->
                    </center>
